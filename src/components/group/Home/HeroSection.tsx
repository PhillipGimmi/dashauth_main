...
const HeroSection = () => {
  ...
  const handleContextChange = useCallback((newContext: keyof BusinessContexts) => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen w-full overflow-hidden overscroll-none bg-gray-950/80 pt-16 dark:bg-gray-50/80 sm:pt-0"
    ...
    >
        ...
        <div className="mb-12 hidden justify-center gap-4 md:flex">
          {Object.entries(businessContexts).map(([key]) => {
            ...
            return (
              ...
              >
                <span
                  className={`h-5 w-5 ${isActive ? 'text-white dark:text-black' : 'text-gray-400 dark:text-gray-600'}`}
                >
                  <Icon />
                </span>
            ...
            <div className="relative z-[2] flex h-full flex-col space-y-6 sm:space-y-8">
              ...
              >
                <div className="flex items-center justify-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center text-gray-400 dark:text-gray-600">
                    <ContextIcon />
                  </div>
                  <motion.div
                    className="md:hidden"
                ...
                <AnimatePresence>
                  {isContextMenuOpen && (
                    <motion.div
                      ...
                      animate="animate"
                      exit="exit"
                      className="absolute left-0 top-full z-50 mt-2 w-56 overflow-hidden rounded-xl border border-gray-700/50 bg-gray-800/95 shadow-2xl backdrop-blur-sm dark:border-gray-300/50 dark:bg-gray-100/95 md:hidden"
                    >
                      {Object.entries(businessContexts).map(([key]) => {
                        const Icon = businessContexts[key as keyof BusinessContexts].icon;
                        const isActive = activeContext === key;
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.h1
                    ...
                    initial="initial"
                    animate="animate"
                    className="text-3xl font-light leading-[1.1] tracking-tight text-white dark:text-black sm:text-4xl sm:leading-tight lg:text-6xl 2xl:text-7xl"
                  >
                  ...
                  <div className="lg:max-w-[85%]">
                    <motion.div
                      ...
                      initial="initial"
                      animate="animate"
                      className="text-2xl font-light text-gray-400 dark:text-gray-600 sm:text-3xl lg:text-4xl 2xl:text-5xl"
                    >
                  ...
                  <div className="lg:max-w-[85%]">
                    <motion.p
                      ...
                      initial="initial"
                      animate="animate"
                      className="text-base leading-relaxed text-gray-400 dark:text-gray-600 sm:text-lg lg:text-xl 2xl:text-2xl"
                    >
                  ...
                  >
                    <div className="w-full lg:max-w-[85%]">
                      ...
                      <motion.button
                        ...
                        initial="initial"
                        animate="animate"
                        className="group w-full whitespace-nowrap rounded-xl border border-gray-800/50 bg-gray-900/20 px-8 py-3.5 text-base text-gray-400/70 backdrop-blur-sm transition-colors hover:bg-gray-800/60 hover:text-white dark:border-gray-200/50 dark:bg-gray-100/20 dark:text-gray-600/70 dark:hover:bg-white dark:hover:text-black"
      ...
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-[20%] bg-gradient-to-t from-black/95 to-transparent dark:from-white/95"
        aria-hidden="true"
      />
    </section>
  );
