...
// Extract button text logic to a function
const getButtonText = (isSubmitting: boolean, error: string | null): string => {
...
// Update the PublicVerificationPanel props interface
const PublicVerificationPanel: React.FC<{
...
// Update the PrivateVerificationPanel props interface
...
}> = ({ showHelp, setShowHelp, searchQuery, setSearchQuery }) => (
  <AnimatePresence>
    {showHelp && (
      <motion.div
        initial={{ x: '100%' }}
...
export const SetupStep: React.FC<SetupStepProps> = ({
  ...
  useEffect(() => {
    ...
    const checkVerificationStatus = () => {
      ...
      handleVerifyScript(); // Just call handleVerifyScript directly
    };
                ...
                <div className="space-y-6">
                  ...
                  >
                    <motion.span className="relative z-10">
                      {getButtonText(isSubmitting, error)}
                    </motion.span>
